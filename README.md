...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-opencl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-opencl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-opencl cuda-opencl-dev
# for installing globally
pixi global install cuda-opencl cuda-opencl-dev
```
...
It is possible to list all of the versions of `cuda-opencl` available on your platform:
...
```
pixi search cuda-opencl --channel conda-forge
```
